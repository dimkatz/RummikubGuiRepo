...
public class SceneIdentifier 
{
    ...
    public static final String GAME_PREFERENCES_SCENE_NAME = "GamePreferencesController";
    public static final String GAME_PREFERENCES_SCENE_PATH = "/scenes/GamePreferencesScene.fxml";
}
